...
export const backendSkillsListData: IListData = {
  Basics: [
    {
      primaryText: "Backbone of frontent development - HTML",
      secondaryText:
        "Good knowlerge of the HTML. Semantic and logic, metas etc.",
    },
    {
      primaryText: "CSS",
      secondaryText:
        "Pure CSS, how it works. Cascades, priority, modern approaches. BEM, preprocessors." +
